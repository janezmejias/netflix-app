...
public class Inicializador {
    ...
    /**
     * Metodo para levantar la aplicacion
     *
     * @param args
     */
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                VistaPantallaPrincipal vistaPantallaPrincipal = VistaPantallaPrincipal.getInstance();
                vistaPantallaPrincipal.setControlador(controladorVistaPrincipal);
                vistaPantallaPrincipal.abrir();
            }
        });
    }
}
