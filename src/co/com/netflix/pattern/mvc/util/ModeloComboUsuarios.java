 ...
 *
 */
public class ModeloComboUsuarios extends AbstractListModel implements ComboBoxModel {
     ...
     * @param arreglo
     */
    public ModeloComboUsuarios(Usuario[] arreglo) {
        super();
     ...
     * @param lista
     */
    public ModeloComboUsuarios(ArrayList<Usuario> lista) {
        if (lista != null) {
     ...
     * @param list
     */
    public void llenar(ArrayList<Usuario> list) {
    ...
    public String getElementAt(int index) {
        if (index > -1 && index < items.size()) {
            return items.get(index).getNombre() + " | " + items.get(index).getCorreo();
        } else {
            return null;
        }
    }
